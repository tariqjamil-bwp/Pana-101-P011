...
**Practice handing AI something that is not text.** ⚡ Needs: a photo on your device (receipt, handwritten note, whiteboard)

Used **Gemini 2.5 Pro (vision)** — the multimodal model for image/audio/video input.

### Image input — transcribe (Daily)
**Prompt:** *[Uploaded photo of a handwritten grocery/receipt note]*
> "Here's a photo of a handwritten note. Transcribe what it says. Keep the original wording. If a word is unclear, mark it [unclear] and give your two best guesses."
...
- Rice — basmati, 5lb bag
- [unclear: "tamir" or "tamar"] paste — 1 jar
- Yogurt — plain, [unclear: "greek" or "green"] label
- Apples — 6
```
> The handwriting for item #6 was slanted — best guess is "tamarind" paste given the grocery context. Item #7 could be "Greek" or "green" label yogurt — the tail on the first letter was ambiguous.

### Image input — whiteboard summary (Work)
**Prompt:** *[Uploaded photo of a meeting whiteboard with mind map, arrows, and circled items]*
> "Here's a photo of a whiteboard from a meeting. List the main points as bullets, then list any action items you can spot. Flag anything you couldn't read with confidence."

**Gemini 2.5 Pro reply:**
> **Main points:**
> - Q2 goal: 20% revenue increase (target: $50K)
> - New channel: TikTok Shop integration
> - Team expansion: 2 social media hires
> - Budget reallocation: reduce print ads → redirect to influencer marketing
>
> **Action items:**
> 1. Research TikTok Shop API requirements — Ali (by 06/15)
> 2. Draft job descriptions for 2 social media roles — Sara (by 06/12)
> 3. Present budget reallocation proposal — Zain (next Monday)
>
> **Flags:** The whiteboard has a sidebar in faint marker. "Something about [unclear: "b2b" or "b2c"] partnership — same color as the brainstorming bubble." Could not read confidently.

### Bonus — Image prompt generation
**Prompt:**
> "Write me a detailed image-generation prompt for a cozy, watercolor-style illustration of a cat reading a book by a window, suitable for a greeting card."

**Gemini 2.5 Pro reply:**
> *"A cozy watercolor illustration of an orange tabby cat curled up on a worn velvet armchair, reading a hardcover book by a rain-streaked window. Soft natural light from the window casts warm amber tones across the scene. Visible brush texture and paper grain. Palette: warm creams, burnt orange, deep teal, soft gray. Composition: cat centered in lower third, book open with pages catching light, window frame creating a left-side border. Greeting card aspect ratio (4:5). --v 6.1 --style expressive"*

### ✍ Observation
Feeding images directly instead of describing them in text produced significantly richer results. The receipt transcription captured almost everything correctly — only flagged 2 items out of 8 as uncertain. The whiteboard summary extracted not just text but also relationships (arrows connecting items, circled priorities). The AI is great at the gist but weak on tiny detail — I had to check the two flagged items manually. Total time saved vs typing it myself: ~8 minutes.

### Takeaway
AI does the boring 90% (typing it out) so you focus on the careful 10% (checking what it flagged). Feed the image directly rather than describing it — a photo is worth a thousand prompt words. For audio, transcribe first then analyze the text. The multimodal gap is closing fast: Gemini 2.5 Pro and GPT-4o handle image, audio, and video natively.
